...
//     document.getElementByClass('filter').innerHTML = items.map((item)=>
//     {
...
//           <button class="add-to-cart-button button-primary js-add-to-cart" data-product-id=${item.id} data-product-price="${(product.priceCents/100).toFixed(2)}" data-product-name="${product.name}" data-product-image="${product.image}">
//             Add to Cart
//           </button>
//         </div>
